package net.lody.lodylandmod.block;

import net.lody.lodylandmod.LodyLandMod;
import net.lody.lodylandmod.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, LodyLandMod.MOD_ID);
